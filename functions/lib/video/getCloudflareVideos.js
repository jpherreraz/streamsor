...
exports.getCloudflareVideos = void 0;
...
exports.getCloudflareVideos = (0, https_1.onCall)(config_1.functionConfig, async (request) => {
    try {
        ...
        const videos = await Promise.all(data.result.map(async (video) => {
            ...
            return {
                ...
                thumbnail: `https://videodelivery.net/${video.uid}/thumbnails/thumbnail.jpg?height=180`,
...
//# sourceMappingURL=getCloudflareVideos.js.map